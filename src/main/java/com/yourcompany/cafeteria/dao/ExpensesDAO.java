...
public class ExpensesDAO {
  ...
  public ResultSet listByShift(int shiftId) throws SQLException { PreparedStatement ps = conn.prepareStatement("SELECT id,amount,description,category,recorded_by,recorded_at,shift_id FROM expense WHERE shift_id=?"); ps.setInt(1, shiftId); return ps.executeQuery(); }
}
