...
CREATE TABLE shift(id IDENTITY PRIMARY KEY, cashier_id INT, started_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, ended_at TIMESTAMP, starting_float DECIMAL(18,2) DEFAULT 0);
